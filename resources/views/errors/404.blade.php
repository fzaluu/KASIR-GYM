...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | Virgo Gym</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="error-card">
        <div class="icon-box">
            <!-- Ikon Dokumen / Pencarian Hilang -->
            <svg width="32" height="32" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
            </svg>
        </div>
        <h1>Halaman Tidak Ditemukan</h1>
        <p>Alamat URL yang kamu akses tidak tersedia atau sudah dipindahkan.</p>
        <a href="{{ url('/') }}" class="btn-dashboard" id="retryLink">Kembali ke Dashboard</a>
        <div class="brand">Virgo Gym System</div>
    </div>
</body>
</html>
<script>
