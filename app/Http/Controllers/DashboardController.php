...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $totalKemarin = Transaksi::where('tipe_transaksi', 'Harian')
                                 ...
                                 ->count();
        $data = [
            'logaktivitas'      => Transaksi::whereDate('created_at', $hariIni)->orderBy('created_at', 'desc')->get(),
            ...
            'daftarMember'      => Member::whereDate('tanggal_kadaluarsa', '>=', $hariIni)->orderBy('nama_member', 'asc')->get(),
            ...
            'hargaPaket'        => HargaPaket::all(), // Data harga dinamis
        ];
